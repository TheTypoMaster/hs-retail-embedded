...
public class InventoryBillFull implements BaseColumns{
	 ...
	 * <p>Type: TEXT</>
	 */
	public static final String TIME = "InventoryBill."+InventoryBill.CREATE_DATE;

	/**
	 * Projection for the selection of InventoryBill.
	 * <p>Type: String[]</>
	 */
	public static final String[] PROJECTION = new String[]{IBILL_ID,IBILL_NUM,FINISHED,RESULT,TIME,OPER_NAME};
}
