...
//	public static final String IItem_ID = InventoryItem._ID;
	
	public static final String[] PROJECTION = new String[]{GOODS_NAME,UNIT_NAME,GOODS_PRICE_ID,
		GOODS_INPRICE, EXPECT_NUM,REAL_NUM,ITEM_RESULT,IBILL_ID};
