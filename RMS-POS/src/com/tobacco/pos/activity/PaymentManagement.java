...
//	private GoodsKindCPer gKindCPer = null;
	...
	private Button addSaleGoodsButton;
...
//	private double otherMoney = 0;//在一张单中其他商品的总价
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addSaleGoodsButton = (Button)this.findViewById(R.id.addSaleGoodsButton);
		addSaleGoodsButton.setOnClickListener(new OnClickListener(){
