...
public class ShowCountGoodsDetail extends Activity{
...
//	private static final int GET_DATA = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.show_count_goods_detail);
		String goodsPriceId = intent.getStringExtra(GoodsPrice._ID);
		String count = intent.getStringExtra("COUNT");
		
		
		Button okButton = (Button)findViewById(R.id.okButtonShowCountGoodsDetail);
...
//		getData(String.valueOf(consumeId));
		showConsumeGoods(goodsPriceId,count);
	}
	
	protected void showConsumeGoods(String goodsPriceId,String count){
		...
		EditText kindsNameText = (EditText)findViewById(R.id.goodsKindShowCountGoodsDetail);
		EditText manfaNameText = (EditText)findViewById(R.id.manuNameShowCountGoodsDetail);
		EditText goodsNameText = (EditText)findViewById(R.id.goodsNameShowCountGoodsDetail);	
		EditText unitNameText = (EditText)findViewById(R.id.unitNameShowCountGoodsDetail);
		EditText inPriceText = (EditText)findViewById(R.id.goodsPriceShowCountGoodsDetail);
		EditText numberText = (EditText)findViewById(R.id.goodsCountShowCountGoodsDetail);
		EditText totalText = (EditText)findViewById(R.id.totalPriceShowCountGoodsDetail);
