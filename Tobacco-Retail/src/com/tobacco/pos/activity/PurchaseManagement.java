...
public class PurchaseManagement extends TabActivity {
	...
	private TextView pBillIdTView;// 进货单编号
	private TextView pBillTimeTView;// 添加进货单的时间
	private EditText pBillCommentEText;// 添加进货单时的备注
	    ...
	    mTabHost.setOnTabChangedListener(new OnTabChangeListener(){
			...
			public void onTabChanged(String tabId) {
				...
				if(tabId.equals("pBill")){
					...
					savePBillButton.setOnClickListener(new OnClickListener() {// "保存"按钮的监听事件
						...
						public void onClick(View v) {
							...
							if(flag)
								Toast.makeText(getApplicationContext(), "成功添加进货单成功!", Toast.LENGTH_SHORT).show();
							else
