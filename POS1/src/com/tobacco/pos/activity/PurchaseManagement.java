...
public class PurchaseManagement extends Activity {
	...
	int priceId = 0;
	String pBillCode = "";//进货单的代码
	int selectedPBillId = 0;//进货单的ID
	int selectedPriceId = 0;//选择的价格的ID
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		welcome.setText("你好：" + this.getIntent().getStringExtra("userName"));
		...
		purchasereturn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				loginer.logout(loginer.getWritableDatabase());// 登出
